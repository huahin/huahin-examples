 ...
 *
 */
public class MetaPathRankingJobTool extends SimpleJobTool {
    @Override
    ...
    protected void setup() throws Exception {
        ...
        final String[] firstFileterLabels = { "DATE", "PATH", "USER", };
        final String[] firstSummarizerLabels = { "DATE", "PATH", "PV", "UU" };
        final String[] secondSummarizerLabels = { "PATH", "RANK", "PV", "UU" };
