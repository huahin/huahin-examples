...
public class FirstFilter extends Filter {
    ...
    public void filter(Record record, Writer writer)
        ...
        emitRecord.addGrouping("ID1", record.getValueString("ID1"));
        emitRecord.addGrouping("ID2", record.getValueString("ID2"));
        emitRecord.addValue("USER", record.getValueString("USER"));
        emitRecord.addValue("NAME", record.getValueString("NAME"));
